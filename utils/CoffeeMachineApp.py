    ...
    def execute(self):
        ...
        while True:
            ...
            if choice == "1":
                ...
                ingredients_quantity_update_file = open(
                    ingredients_quantity_update_file_name, "r"
                )
                ingredients_quantity_update = json.load(
                ...
                print(
                    f"Only first {self._coffee_service.get_num_outlets()} orders will be served!"
                )
